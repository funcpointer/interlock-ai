...
LINES: list[tuple[str, str]] = [
    ...
    ("Rated Power", "1100 kVA"),  # TP-CD-2: mismatch with Eaton "1000 KVA"
    ("Primary Voltage", "12.47 kV"),  # TP-CD-3: mismatch with Eaton "13.8 kV"
    ("Secondary Voltage", "480 V"),  # FP-CD-1: matches Eaton
    ("Rated Impedance", "5.7 %"),  # TP-CD-1: mismatch with Eaton "5.75 %Z"
